...
export default function Cookies() {
  return (
    <LegalPage eyebrow="Cookies" title="Small files, small footprint." updated="July 2026">
      ...
      <h3>Functional</h3>
      <p>These make the site more convenient. You can browse fine without them.</p>
      <ul>
        <li><strong>Filter memory</strong> — remembers which job filters you had selected so a refresh doesn't reset them</li>
        <li><strong>Chatbot history</strong> — keeps your chat with the Whofy assistant across page loads</li>
      </ul>
