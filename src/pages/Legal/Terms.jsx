...
export default function Terms() {
  return (
    <LegalPage eyebrow="Terms of Use" title="How Whofy works with you." updated="July 2026">
      ...
      <h2>Job listings</h2>
      <p>The jobs shown on Whofy come from public company career pages and free job APIs. We try to keep listings fresh (roles are refreshed every 24 hours) but we can't guarantee every listing is still open the moment you apply. Details like salary or location come straight from the employer's posting.</p>
