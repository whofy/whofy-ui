...
const ITEMS = [
  ...
  { num: '2', title: 'Made for freshers', body: 'Zero to two years is our whole focus. Every partner company on Whofy has an active early-career track — no filters to fight, no ghost postings.' },
